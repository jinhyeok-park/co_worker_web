...
@Mapper
public interface UserApplicantsMapper {
    ...
    ArrayList<UserApplicants> selectUser_applicantsByProposal_id(@Param("proposal_id") long proposal_id);

    @Select("SELECT * FROM user_applicants WHERE user_id = #{user_id}")
    ArrayList<UserApplicants> selectUser_applicantsByUser_id(@Param("user_id") String user_id);
