    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        (function(marker, title) {
            ...
            kakao.maps.event.addListener(marker, 'click', function() {
                var clickedInfo = document.getElementById("clickedInfo");
                ...
                geocoder.coord2Address(position.getLng(), position.getLat(), function(result, status) {
                    if (status === kakao.maps.services.Status.OK)
                    {
                        ...
                        var axis_x = document.getElementById("load_x");
                        var axis_y = document.getElementById("load_y");

                        axis_x.value = position.getLat();
                        axis_y.value = position.getLng();
