...
<body class="flex h-screen overflow-hidden">
    ...
    <div id="documentList" class="w-1/6 p-4 bg-gray-200 overflow-auto">
        <button id="addDocument" class="py-2 mb-4 px-4 font-bold">Add Document</button>
        <hr>
    ...
    <div id="editorContainer" class="flex flex-col w-5/6 h-5/6">
        <div class="flex h-screen">
            <div class="flex flex-col w-1/2 p-4">
                ...
                <textarea id="markdownInput" placeholder="Write your markdown content here..." class="custom-scrollbar flex-1 p-4 bg-white border-none rounded resize-none" style=" min-height: calc(100vh - 180px); overflow: auto;"></textarea>
            </div>
            <div id="markdownPreview" class="custom-scrollbar w-1/2 max-h-2/3 overflow-y-auto p-4 bg-white rounded border-none  mr-10" style="min-height: calc(103vh - 180px); overflow: auto; margin-top: 70px;"></div>
        </div>
