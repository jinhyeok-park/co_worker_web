...
<body class="bg-gray-200">
    <div class="max-w-6xl border-none rounded shadow bg-white mx-auto py-10">
        ...
        <form onsubmit="searchPlaces(); return false;">
            <div class="map_wrap mx-auto w-full border rounded shadow">
                ...
                <div id="menu_wrap" class="bg_white">
                    <div class="option flex w-full">
                        <div class="w-3/4">
                            <input class="w-full" type="text" value="성수역" id="keyword" size="15">
                        </div>
                        <div class="w-1/4">
                            <button class="btn-search w-18 py-1 px-1 text-white rounded m-1" type="submit" style="margin-top: 10px;">검색하기</button>
                        </div>
                    </div>
                    <hr>
                    <ul id="placesList"></ul>
